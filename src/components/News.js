...
export class News extends Component {
  ...
  fetchMoreData = async () => {
    let url =
      `https://newsapi.org/v2/top-headlines?country=${this.country.value}&category=${this.props.category}&apiKey=${this.props.API_KEY}&pageSize=${this.props.pageSize}&page=${this.state.page}`;
